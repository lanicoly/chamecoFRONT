...
export function EmprestimosPendentes({ emprestimos, salas, chaves, solicitantes, responsaveis, pesquisa }: EmprestimosPendentesProps) {
  ...
  //constante para filtrar data de retirada
