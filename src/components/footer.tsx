  ...
  return (
    <footer className="w-full bg-white border-t border-gray-100">
      <div className="max-w-6xl mx-auto px-1 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[60px] mb-8">
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-[23px] font-bold mb-2 text-nowrap text-[#081683]">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-base text-[#081683] text-center text-nowrap md:text-left">
