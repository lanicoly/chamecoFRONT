...
export function MenuTopo({ mudarTela } : MenuTopoProps) {
    return (
        
        <nav className="flex justify-between px-4 py-2 bg-white fixed top-0 w-full z-10 items-center">
        <button onClick={() => mudarTela(1)} className="flex gap-2 justify-start items-center font-medium text-lg text-sky-900 w-auto">
