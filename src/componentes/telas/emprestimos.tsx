...
export function Emprestimos({
  ...
  function editarObservacao(e: React.FormEvent) {
    ...
    if (emprestimoSelecionado && observacao) {
      const novoEmprestimoSelecionado = emprestimos.map((emprestimo) =>
        emprestimo.id == emprestimoSelecionado.id
          ? { ...emprestimo, observacao }
          : emprestimo
      );
      setEmprestimoSelecionado({...emprestimoSelecionado, observacao})
      setEmprestimos(novoEmprestimoSelecionado);
      setObservacao("");
      closeEditModal();
    }
  }
              ...
              <table className="w-full border-separate border-spacing-y-2 bg-white">
                <thead className="bg-white sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="text-left text-[10px] sm:text-[12px] font-medium text-sky-900 pl-2 w-[10%]">
                      Hora retirada
                    </th>
                                ...
                                <form className="container flex flex-col gap-2 w-full px-4 py-4 h-auto rounded-[15px] bg-white mx-5 max-w-[500px]">
                                  <div className="flex justify-between w-full px-3">
                                    ...
                                    <div className="flex justify-center items-center gap-3">
                                      ...
                                      {/* Começo do pop up de editar observacao de um emprestimo */}
                                      {isEditModalOpen && (
                                        <div className="fixed flex items-center justify-center inset-0 bg-black bg-opacity-50 z-20">
                                          <form
                                      ...
                                      {/* Adicionando pop up de deletar observacao de um emprestimo */}
                                      {isDeleteModalOpen && (
                                        <div className="fixed flex items-center justify-center inset-0 bg-black bg-opacity-50 z-20">
                                          <form
                                      ...
                                      {/* fim do pop up de excluir observacao */}
                                  ...
                                  <div className="flex w-full h-auto px-[10px] py-2 mb-4 flex-col rounded-lg bg-[#B8BCE0]">
                                    <p className="text-[#192160] font-medium p-1">
                                      {emprestimoSelecionado?.observacao || "Detalhes a cerca do empréstimo."}
                                    </p>
                                  </div>
                                </form>
                              </div>
